 ...
 */
public class OWLDisjointObjectPropertiesAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLDisjointObjectPropertiesAxiomImpl (ontologyManager.getOWLDataFactory (), new HashSet<OWLObjectPropertyExpression> (), new HashSet<OWLAnnotation> ());
	}
}
