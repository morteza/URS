 ...
 */
public class OWLDisjointClassesAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLDisjointClassesAxiomImpl (ontologyManager.getOWLDataFactory (), new HashSet<OWLClassExpression> (), new HashSet<OWLAnnotation> ());
	}
}
