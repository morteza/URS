...
/**
 * Instantiates an OWL typed constant.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 * @author Morteza Ansarinia (ITRC)
 */
public class OWLLiteralInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return null;//ontologyManager.getOWLDataFactory ().getOWLLiteral ("");
	}
