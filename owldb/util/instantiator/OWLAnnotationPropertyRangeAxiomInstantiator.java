...
/**
 * Instantiates an OWLAnnotationPropertyRangeAxiom.
 * 
 * @author J&ouml;rg Henss (KIT)
 * @author Morteza Ansarinia (ITRC)

 */
public class OWLAnnotationPropertyRangeAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return null;//new OWLAnnotationPropertyRangeAxiomImpl (ontologyManager.getOWLDataFactory (), null, null, new HashSet<OWLAnnotation> ());
	}

	@Override
	public Object instantiate(OWLDataFactory dataFactory, String entityName,
			IRI iri, Serializable id) {
		return dataFactory.getOWLAnnotationPropertyRangeAxiom(null, null, new HashSet<OWLAnnotation>());
	}
}
