...
/**
 * Instantiates an OWLReflexiveObjectPropertyAxiom.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class OWLReflexiveObjectPropertyAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLReflexiveObjectPropertyAxiomImpl (ontologyManager.getOWLDataFactory (), null, new HashSet<OWLAnnotation> ());
	}
}
