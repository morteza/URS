...
/**
 * Instantiates an OWL different individuals instantiator.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class OWLDifferentIndividualsInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLDifferentIndividualsAxiomImpl (ontologyManager.getOWLDataFactory (), new HashSet<OWLIndividual> (), new HashSet<OWLAnnotation> ());
	}
}
