 ...
 */
public class SWRLObjectPropertyAtomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new SWRLObjectPropertyAtomImpl (ontologyManager.getOWLDataFactory (), null, null, null);
	}
}
