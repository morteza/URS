...
/**
 * Instantiates an OWLInverseFunctionalObjectPropertyAxiom.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class OWLInverseFunctionalObjectPropertyAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLInverseFunctionalObjectPropertyAxiomImpl (ontologyManager.getOWLDataFactory (), null, new HashSet<OWLAnnotation> ());
	}
}
