...
/**
 * Instantiates an OWL object union of.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class OWLObjectUnionOfInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLObjectUnionOfImpl (ontologyManager.getOWLDataFactory (), new HashSet<OWLClassExpression> ());
	}
}
