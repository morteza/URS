...
/**
 * Instantiates an OWL data exact cardinality restriction.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 * @author Morteza Ansarinia (ITRC)
 */
public class OWLFacetRestrictionInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return null;//ontologyManager.getOWLDataFactory ().getOWLFacetRestriction (null, null);
	}

	@Override
	public Object instantiate(OWLDataFactory dataFactory, String entityName,
			IRI iri, Serializable id) {
		return dataFactory.getOWLFacetRestriction (null, null);
	}
}
