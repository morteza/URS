 ...
 */
public class OWLSubDataPropertyOfAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return ontologyManager.getOWLDataFactory ().getOWLSubDataPropertyOfAxiom (null, null);
	}
}
