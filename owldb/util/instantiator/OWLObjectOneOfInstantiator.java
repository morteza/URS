...
/**
 * Instantiates an OWL object one of.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class OWLObjectOneOfInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLObjectOneOfImpl (ontologyManager.getOWLDataFactory (), new HashSet<OWLIndividual> ());
	}
}
