...
/**
 * Instantiates an OWL object sub property axiom.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class OWLSubObjectPropertyOfAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return ontologyManager.getOWLDataFactory ().getOWLSubObjectPropertyOfAxiom (null, null);
	}
}
