 ...
 */
public class OWLNegativeDataPropertyAssertionAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLNegativeDataPropertyAssertionImplAxiom (ontologyManager.getOWLDataFactory (), null, null, null, new HashSet<OWLAnnotation> ());
	}
}
