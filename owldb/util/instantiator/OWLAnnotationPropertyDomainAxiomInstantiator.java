...
/**
 * Instantiates an OWLAnnotationPropertyDomainAxiom.
 * 
 * @author J&ouml;rg Henss (KIT)
 * @author Morteza Ansarinia (ITRC)
 */
public class OWLAnnotationPropertyDomainAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return null;//new OWLAnnotationPropertyDomainAxiomImpl (ontologyManager.getOWLDataFactory (), null, null, new HashSet<OWLAnnotation> ());
	}

	@Override
	public Object instantiate(OWLDataFactory dataFactory, String entityName,
			IRI iri, Serializable id) {
		return dataFactory.getOWLAnnotationPropertyDomainAxiom(null, null, new HashSet<OWLAnnotation>());
	}
}
