...
/**
 * Instantiates an OWL Disjoint Union Axiom.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class OWLDisjointUnionAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLDisjointUnionAxiomImpl (ontologyManager.getOWLDataFactory (), null, new HashSet<OWLClassExpression> (), new HashSet<OWLAnnotation> ());
	}
}
