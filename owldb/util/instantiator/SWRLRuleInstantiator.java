...
/**
 * Instantiates a SWRL rule.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class SWRLRuleInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return ontologyManager.getOWLDataFactory ().getSWRLRule (new HashSet<SWRLAtom> (), new HashSet<SWRLAtom> ());
	}
}
