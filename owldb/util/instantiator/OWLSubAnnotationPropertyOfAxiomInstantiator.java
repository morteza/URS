 ...
 */
public class OWLSubAnnotationPropertyOfAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLSubAnnotationPropertyOfAxiomImpl (ontologyManager.getOWLDataFactory (), null, null, new HashSet<OWLAnnotation> ());
	}
}
