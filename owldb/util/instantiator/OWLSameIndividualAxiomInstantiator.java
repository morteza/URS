...
/**
 * Instantiates an OWL same individual.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class OWLSameIndividualAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLSameIndividualAxiomImpl (ontologyManager.getOWLDataFactory (), new HashSet<OWLIndividual> (), new HashSet<OWLAnnotation> ());
	}
}
