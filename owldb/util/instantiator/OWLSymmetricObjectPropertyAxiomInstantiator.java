...
/**
 * Instantiates an OWLSymmetricObjectPropertyAxiom.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class OWLSymmetricObjectPropertyAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLSymmetricObjectPropertyAxiomImpl (ontologyManager.getOWLDataFactory (), null, new HashSet<OWLAnnotation> ());
	}
}
