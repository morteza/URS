...
/**
 * Instantiates an OWLIrreflexiveObjectPropertyAxiom.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class OWLIrreflexiveObjectPropertyAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLIrreflexiveObjectPropertyAxiomImpl (ontologyManager.getOWLDataFactory (), null, new HashSet<OWLAnnotation> ());
	}
}
