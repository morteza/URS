...
/**
 * Instantiates an OWL equivalent object properties.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 * @author Morteza Ansarinia (ITRC)
 */
public class OWLEquivalentObjectPropertiesAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return null;//new OWLEquivalentObjectPropertiesAxiomImpl (ontologyManager.getOWLDataFactory (), new HashSet<OWLObjectPropertyExpression> (), new HashSet<OWLAnnotation> ());
	}

	@Override
	public Object instantiate(OWLDataFactory dataFactory, String entityName,
			IRI iri, Serializable id) {
		return dataFactory.getOWLEquivalentObjectPropertiesAxiom(new HashSet<OWLObjectPropertyExpression>(), new HashSet<OWLAnnotation>());
	}
}
