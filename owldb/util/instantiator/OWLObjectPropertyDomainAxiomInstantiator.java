...
/**
 * Instantiates an OWL data property range axiom.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class OWLObjectPropertyDomainAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLObjectPropertyDomainAxiomImpl (ontologyManager.getOWLDataFactory (), null, null, new HashSet<OWLAnnotation> ());
	}
}
