...
/**
 * Instantiates an OWL data sub property axiom.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class OWLSubPropertyChainAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLSubPropertyChainAxiomImpl (ontologyManager.getOWLDataFactory (), new ArrayList<OWLObjectPropertyExpression> (), null, new HashSet<OWLAnnotation> ());
	}
}
