 ...
 */
public class OWLClassAssertionInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return null;//new OWLClassAssertionImpl (ontologyManager.getOWLDataFactory (), null, null, new HashSet<OWLAnnotation> ());
	}

	@Override
	public Object instantiate(OWLDataFactory dataFactory, String entityName,
			IRI iri, Serializable id) {
		return dataFactory.getOWLClassAssertionAxiom(null, null, new HashSet<OWLAnnotation>());
	}
}
