...
/**
 * Instantiates an OWL data one of.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class OWLDataOneOfInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLDataOneOfImpl (ontologyManager.getOWLDataFactory (), new HashSet<OWLLiteral> ());
	}
}
