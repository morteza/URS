...
/**
 * Instantiates an OWL data min cardinality restriction.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class OWLDataMinCardinalityRestrictionInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return ontologyManager.getOWLDataFactory ().getOWLDataMinCardinality (1, null);
	}
}
