 ...
 */
public class OWLEquivalentClassesAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return null;//new OWLEquivalentClassesAxiomImpl (ontologyManager.getOWLDataFactory (), new HashSet<OWLClassExpression> (), new HashSet<OWLAnnotation> ());
	}

	@Override
	public Object instantiate(OWLDataFactory dataFactory, String entityName,
			IRI iri, Serializable id) {
		return dataFactory.getOWLEquivalentClassesAxiom(new HashSet<OWLClassExpression>(), new HashSet<OWLAnnotation>());
	}
}
