 ...
 */
public class SWRLSameIndividualAtomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new SWRLSameIndividualAtomImpl (ontologyManager.getOWLDataFactory (), null, null);
	}
}
