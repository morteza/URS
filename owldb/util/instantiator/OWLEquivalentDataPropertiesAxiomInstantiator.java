 ...
 */
public class OWLEquivalentDataPropertiesAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return null;//new OWLEquivalentDataPropertiesAxiomImpl (ontologyManager.getOWLDataFactory (), new HashSet<OWLDataPropertyExpression> (), new HashSet<OWLAnnotation> ());
	}

	@Override
	public Object instantiate(OWLDataFactory dataFactory, String entityName,
			IRI iri, Serializable id) {
		return dataFactory.getOWLEquivalentDataPropertiesAxiom(new HashSet<OWLDataPropertyExpression>(), new HashSet<OWLAnnotation>());
	}
}
