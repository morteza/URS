...
/**
 * Instantiates an OWL Negative Data Property Assertion Axiom.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class OWLNegativeObjectPropertyAssertionAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLNegativeObjectPropertyAssertionAxiomImpl (ontologyManager.getOWLDataFactory (), null, null, null, new HashSet<OWLAnnotation> ());
	}
}
