 ...
 */
public class SWRLDataPropertyAtomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new SWRLDataPropertyAtomImpl (ontologyManager.getOWLDataFactory (), null, null, null);
	}
}
