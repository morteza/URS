 ...
 */
public class SWRLBuiltInAtomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new SWRLBuiltInAtomImpl (ontologyManager.getOWLDataFactory (), null, new ArrayList<SWRLDArgument> ());
	}
}
