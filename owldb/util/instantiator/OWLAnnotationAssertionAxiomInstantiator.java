 ...
 */
public class OWLAnnotationAssertionAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return null;//new OWLAnnotationAssertionAxiomImpl (ontologyManager.getOWLDataFactory (), null, null, null, new HashSet<OWLAnnotation> ());
	}

	@Override
	public Object instantiate(OWLDataFactory dataFactory, String entityName,
			IRI iri, Serializable id) {
		return dataFactory.getOWLAnnotationAssertionAxiom(null, null, null, new HashSet<OWLAnnotation>());
	}
}
