...
/**
 * Instantiates an OWL constant annotation property.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 * @author Morteza Ansarinia (ITRC)
 */
public class OWLAnnotationPropertyInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return null;//new OWLAnnotationPropertyImpl (ontologyManager.getOWLDataFactory (), null);
	}

	@Override
	public Object instantiate(OWLDataFactory dataFactory, String entityName,
			IRI iri, Serializable id) {
		return dataFactory.getOWLAnnotationProperty(null);
	}
}
