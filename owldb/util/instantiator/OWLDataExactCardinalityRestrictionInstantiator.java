 ...
 */
public class OWLDataExactCardinalityRestrictionInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return ontologyManager.getOWLDataFactory ().getOWLDataExactCardinality (1, null);
	}
}
