...
/**
 * Instantiates an OWL datatype property assertion axiom.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class OWLDataPropertyAssertionAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return ontologyManager.getOWLDataFactory ().getOWLDataPropertyAssertionAxiom (null, null, 1);
	}
}
