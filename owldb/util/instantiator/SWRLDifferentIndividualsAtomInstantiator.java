...
/**
 * Instantiates a SWRL atom I variable.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class SWRLDifferentIndividualsAtomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new SWRLDifferentIndividualsAtomImpl (ontologyManager.getOWLDataFactory (), null, null);
	}
}
