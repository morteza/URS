...
/**
 * Instantiates an OWL object min cardinality restriction.
 * 
 * @author J&uuml;rgen Mo&szlig;graber (Fraunhofer IOSB)
 */
public class OWLObjectMinCardinalityRestrictionInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return ontologyManager.getOWLDataFactory ().getOWLObjectMinCardinality (1, null);
	}
}
