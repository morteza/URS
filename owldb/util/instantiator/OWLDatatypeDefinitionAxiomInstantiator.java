...
/**
 * Instantiates an OWL data type definition.
 * 
 * @author J&ouml;rg Henss (KIT)
 */
public class OWLDatatypeDefinitionAxiomInstantiator implements IInstantiator
{
	/** {@inheritDoc} */
	@Override
	...
	{
		return new OWLDatatypeDefinitionAxiomImpl (ontologyManager.getOWLDataFactory (), null, null, new HashSet<OWLAnnotation> ());
	}
}
